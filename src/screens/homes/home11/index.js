      ...
      <ImageBackground
        ...
        <ScrollView
          ...
          <View style={styles.body}>
            ...
            {check.value === 'PITCHLY FEED' && <AllMixed featuredPost={true} feture={false} isfocused={props.navigation.isFocused()}  />}
            {check.value === 'TALENT FEED' && <Talent featuredPost={true}  feture={false} isfocused={props.navigation.isFocused()}  />}
            {check.value === 'SERVICES FEED' && <Services featuredPost={true}  feture={false} isfocused={props.navigation.isFocused()} />}
            {check.value === 'PRODUCTS FEED' && <Product featuredPost={true}  feture={false} isfocused={props.navigation.isFocused()}  />}
          </View>
        </ScrollView>
      </ImageBackground>
    </>
